...
namespace SUD.UserInterface
{
    public static class SUDUtility
    {
        ...
        public static string SendSMS(string strSMSBody, string strRecipientNo, string strSender)
        {
            ...
            WIP_Report.SendOTP.OTPClient objSMS = new WIP_Report.SendOTP.OTPClient();
            string Response = objSMS.SendMessage(strRecipientNo, strSMSBody);
